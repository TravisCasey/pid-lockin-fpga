`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Function Generator 1 Module generates sine waves with customizable period, 
// phase and amplitude. Maximum frequency is 50 kHz (Low frequency).
// Author: Travis Casey
//////////////////////////////////////////////////////////////////////////////////
...
reg signed [14-1:0] sin_dat_1 [625-1:0];
initial
begin
    $readmemb("sin_1.mem", sin_dat_1);
end
...
begin
    if (final_quadrant == 2'b00)
        y_sin <= sin_dat_1[phase_x];
    else if (final_quadrant == 2'b01)
        y_sin <= sin_dat_1[10'd624 - phase_x];
...
wire signed [AMP_SHIFT+14-1:0] sin_raw;
